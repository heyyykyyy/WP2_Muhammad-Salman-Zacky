...
class Buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        //konfigurasi sebelum gambar upload
    ...
    public function ubahBuku()
    {
        ...
        $kategori        = $this->ModelBuku->joinKategoriBuku(['buku.id' => $this->uri->segment(3)])->resut_array();
        foreach ($kategori as $k) {
            $data['id'] = $k['id_kategori'];
            $data['k']  = $k['kategori'];
        }
        $data['kaategori'] = $this->ModelBuku->getKategori()->result_array();
